...
public class EnumEventoRule implements Specification<Evento> {

    private String colunaNome;
    private String colunaValor;

    public EnumEventoRule(String name, String value) {
    ...
    public Predicate toPredicate(Root<Evento> root, CriteriaQuery<?> query, CriteriaBuilder criteriaBuilder) {
        ...
        return criteriaBuilder.equal(root.get(this.colunaNome), Level.find(this.colunaValor));
    }
